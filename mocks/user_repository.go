...
func (_m *UserRepository) Create(ctx context.Context, _a1 *entity.User) error {
...
func (_m *UserRepository) Delete(ctx context.Context, opts ...gormprovider.QueryOption) error {
...
func (_m *UserRepository) Get(ctx context.Context, opts ...gormprovider.QueryOption) (entity.User, bool, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r1 bool
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, ...gormprovider.QueryOption) (entity.User, bool, error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...gormprovider.QueryOption) entity.User); ok {
		r0 = rf(ctx, opts...)
	} else {
...
func (_m *UserRepository) List(ctx context.Context, opts ...gormprovider.QueryOption) ([]entity.User, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 []entity.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...gormprovider.QueryOption) ([]entity.User, error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...gormprovider.QueryOption) []entity.User); ok {
		r0 = rf(ctx, opts...)
...
func (_m *UserRepository) NewQueryWithOpts(ctx context.Context, opts ...gormprovider.QueryOption) *gorm.DB {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *UserRepository) Patch(ctx context.Context, patch *entity.User, opts ...gormprovider.QueryOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *entity.User, ...gormprovider.QueryOption) error); ok {
...
func (_m *UserRepository) TableName() string {
	ret := _m.Called()
...
func (_m *UserRepository) Update(ctx context.Context, update *entity.User, opts ...gormprovider.QueryOption) error {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
